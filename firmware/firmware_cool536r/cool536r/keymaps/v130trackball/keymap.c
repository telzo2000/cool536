...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_1, KC_2, KC_LCTL, KC_LGUI, LT(_LOWER,KC_SPACE),LT(_RAISE,KC_SPACE),KC_LALT, KC_BSPC,KC_BTN1,KC_BTN2,
    KC_LEFT,KC_RIGHT,KC_UP,KC_DOWN,KC_UP,KC_DOWN,KC_WH_U,KC_WH_D
  ),
  [_LOWER] = LAYOUT(
    KC_1,     KC_2,      KC_3,      KC_4,      KC_5,                KC_6,                KC_7,     KC_8,          KC_9,           KC_0,    
    KC_EXLM,  KC_AT,     KC_HASH,   KC_DLR,    KC_PERC,             KC_CIRC,             KC_AMPR,  KC_ASTR,       KC_LPRN,        KC_RPRN, 
    KC_PPLS,  KC_PMNS,   KC_PAST,   KC_PSLS,   KC_PEQL,             KC_GRV,              KC_JYEN,  RSFT(KC_LBRC), RSFT(KC_RBRC),  RSFT(KC_MINS),
    KC_1, KC_2, KC_ESC, KC_INSERT, LT(_LOWER,KC_SPACE),KC_MINS,KC_LALT, KC_BSPC,KC_BTN1,KC_BTN2,
    KC_LEFT,KC_RIGHT,KC_UP,KC_DOWN,KC_UP,KC_DOWN,KC_WH_U,KC_WH_D
  ) ,
  ...
  [_RAISE] = LAYOUT(
    ...
    KC_1, KC_2, KC_TAB,   KC_LGUI,  RSFT(KC_MINS), LT(_RAISE,KC_SPACE),KC_LALT, TO(_ADJUST),KC_BTN1,KC_BTN2,
    KC_LEFT,KC_RIGHT,KC_UP,KC_DOWN,KC_UP,KC_DOWN,KC_WH_U,KC_WH_D
  ),
   
   [_ADJUST] = LAYOUT(
    RGB_TOG,  KC_F2,      KC_F3,      KC_F4,          KC_F5,               KC_F6,               KC_F7,    KC_F8,     KC_F9,     KC_F10,    
    KC_AT,    KC_BSLS,    KC_SCLN,    RSFT(KC_SCLN),  KC_QUOT,             KC_MS_L,             KC_MS_D,  KC_MS_U,     KC_MS_R,  KC_EQL,
    RGB_TOG,  RGB_MOD,    RGB_HUI,    RGB_HUD,        RGB_SAI,             KC_WH_L,             KC_WH_D,  KC_WH_U,   KC_WH_R,   KC_BSLASH,
    KC_1, KC_2, KC_TAB,   KC_INSERT,  KC_BTN1, KC_BTN2,KC_LALT, TO(_QWERTY),KC_BTN1,KC_BTN2,
    KC_LEFT,KC_RIGHT,KC_UP,KC_DOWN,KC_UP,KC_DOWN,KC_WH_U,KC_WH_D
  )
};
